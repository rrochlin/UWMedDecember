...
def generate_sensor(data,localRoute,startTS,endTS,particles,colorLabel,collectionName,badSensors,label):
# def generate_sensor(x, y, z, num_sensor, file_pass, start_time, end_time, dp_size, color):
    ...
    for idx,obj in enumerate(new_coll.objects):
        ...
        for v in dp:
            ...
            particle_setting(obj, math.log2(v)*2, start, end, colorLabel[newC])
            f = end
...
generate_sensor(data,localRoute,startTS,endTS,particle,colorLabel,collectionName,badSensors,label)
