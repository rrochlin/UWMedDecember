...
def generate_sensor(expirement,localRoute,particles,colorLabel,collectionName,badSensors,sensors):
    ...
    for i in sensorLoc:
            ...
            b01 = bpy.ops.mesh.primitive_torus_add(
                major_radius = 1.4,
                minor_radius=1,
                location=(sensors[i])
                )
...
index = 0
sensors = locationZone

expirement = data[index]

localRoute = os.path.join('C:/Users/RobertRochlin/Documents/UW/covidDataProject/UWMedDecember/stretchedAvgData/'+ expirement +'.csv')

collectionName = expirement
